...
class ReuseAttempt(vrwObject):
    def __init__(self):
        super().__init__("reuse-attempt")

class ReuseVehicle(vrwObject):
    def __init__(self):
        super().__init__("reuse-vehicle")

class Spacecraft(vrwObject):
    def __init__(self):
